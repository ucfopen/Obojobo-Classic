...
try
{
	...
	<html>
		...
		if($validCount > 0)
		{
			...
			<p>If you are a New Undergraduate Student or a New Master's Program Student <strong>admitted in Fall 2012</strong> or later, you are required 
to complete all the Academic Integrity Modules listed below in your group.</p>
			<p>You need to score <strong><?php echo $minScore; ?>% or higher on all required modules before September 15, 2012</strong>. Otherwise you 
will receive a hold that prevents you from registering for classes.</p>
