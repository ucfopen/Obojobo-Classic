...
//   $stats[] = array ('name' => '27_PageLayoutsAll', 'value'=>"SELECT ".\cfg_obo_Layout::ID." AS LAYOUT, count(".\cfg_obo_Page::ID.") as COUNT FROM ".\cfg_obo_Page::TABLE." Group By ".\cfg_obo_Layout::ID."");
   ...
   $stats[] = array ('name' => '30_InstanceIndividualViewsByDay', 'value'=>"SELECT DATE_FORMAT(FROM_UNIXTIME(T.".\cfg_obo_Track::TIME."), '%m-%d-%Y') AS DATE, COUNT(T.".\cfg_obo_Track::TIME.") AS VISITS, CONCAT(L.title, ' v.', L.".\cfg_obo_LO::VER.") AS MASTER FROM ".\cfg_obo_Track::TABLE." AS T, ".\cfg_obo_Instance::TABLE." AS I, ".\cfg_obo_LO::TABLE." AS L WHERE T.".\cfg_obo_Track::TYPE." = '\obo\log\Visited' AND T.".\cfg_obo_Instance::ID." = I.".\cfg_obo_Instance::ID." AND L.".\cfg_obo_LO::ID." = I.".\cfg_obo_LO::ID." AND T.".\cfg_obo_Track::TIME." > 1214193600 GROUP BY DATE, MASTER ORDER BY T.".\cfg_obo_Track::TIME.", MASTER");
...
$stats[] = array ('name' => '9999_StudentVisitContactList', 'value'=>
	"SELECT
		...
		AND 
			T.".\cfg_obo_Track::TYPE." = '\obo\log\Visited'
		AND
