...
<html> 
		...
		<link rel="stylesheet" type="text/css" href="[+wf_base_url+]includes/debug/main.template.css" />
        </head>
        <body>
...
<img src="[+dbg_icon_url+]" /> <a href="[+open_url+]" onclick="window.open('[+open_url+]','[+dbg_title+]','width=720, height=500, toolbar=0, menubar=0, status=0, alwaysRaised=1, dependent=1, scrollbars=1, resizable=yes');return false;">[+open_dbg_console+]</a><br />
