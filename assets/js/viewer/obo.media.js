...
obo.media = function()
{
	...
	var buildYouTubeVideo = function($placeholder)
	{
		...
		console.log('buildYouTubeVideo=', youtubeID);
	...
	{
		console.log('createMedia', mediaObject.width, mediaObject.height, mediaObject);
		...
		switch(mediaObject.itemType.toLowerCase())
		{
			...
			case 'swf':
				...
				console.log('isCaptivate=');
				console.log(obo.model.getPageObject());
				console.log($('.question-page').hasClass('question-type-Media'));
				...
				console.log('mediaObject', mediaObject, 'maxWidth', maxWidth, 'mediaWidth', mediaWidth, 'mediaHeight', mediaHeight);
				*/
		...
		if(pageItemOptions == null)
		{
			...
			console.log('1. mediaObject.width', mediaObject.width, 'mediaObject.height', mediaObject.height);
			...
			console.log('4. mediaObject.width', mediaObject.width, 'mediaObject.height', mediaObject.height);
		...
		//	mediaObject.height = 10;
			...
			console.log('6. $mediaElement.width', $mediaElement.width(), '$mediaElement.height', $mediaElement.height());
		}
