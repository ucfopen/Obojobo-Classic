	...
	function service() {
		...
		{			
			...
			if(AppCfg::PROFILE_MODE)
			{
				...
				core_util_Log::profile('amfphp_Filters', "'".$_SESSION['userID'].'\','.$timer."'".round($tTime,5)."','".strlen($amf->outputStream)."',".time()."','$mem1','".memory_get_usage(true)."','".memory_get_peak_usage(true)."'\n");
			}
