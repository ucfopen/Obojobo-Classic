...
export const MCSingleItemQuestion = Template.bind({})
MCSingleItemQuestion.args = {
	question: {
		questionID: '19683',
		userID: 6661,
		itemType: 'MC',
...
export const ShortAnsMultipleItemQuestion = Template.bind({})
ShortAnsMultipleItemQuestion.args = {
	question: {
		questionID: '19684',
		userID: 6661,
		itemType: 'QA',
...
export const MateriaQuestion = Template.bind({})
MateriaQuestion.args = {
	question: {
		questionID: '19685',
		userID: 6661,
		itemType: 'Media',
...
export const FlashQuestion = Template.bind({})
FlashQuestion.args = {
	question: {
		questionID: '19687',
		userID: 6661,
...
export const MCSingleItemQuestionWithStudentResponse = Template.bind({})
MCSingleItemQuestionWithStudentResponse.args = {
	question: {
		questionID: '19683',
		userID: 6661,
		itemType: 'MC',
...
export const ShortAnsQuestionWithStudentResponse = Template.bind({})
ShortAnsQuestionWithStudentResponse.args = {
	question: {
		questionID: '19684',
		userID: 6661,
		itemType: 'QA',
...
export const MateriaQuestionWithResponse = Template.bind({})
MateriaQuestionWithResponse.args = {
	question: {
		questionID: '19685',
		userID: 6661,
		itemType: 'Media',
