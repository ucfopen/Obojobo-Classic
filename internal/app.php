...
$app = new Logger('app');
$handler = new RotatingFileHandler(\AppCfg::DIR_BASE.'internal/logs/obojobo', 0, Logger::DEBUG, true, 664);
...
function profile($name, $stuff)
{
	if ( ! Registry::hasLogger($name))
	{
		...
		$handler = new RotatingFileHandler(\AppCfg::DIR_BASE.'internal/logs/profile-'.$name, 0, Logger::INFO, true, 664);
