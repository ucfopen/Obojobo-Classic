<?php
$ASE_timestamp = '1307476823';
$ASE_time = 'June 7, 2011, 4:00 pm';
$ASE_savedby = 'obojobo.ucf.edu,,,10.171.239.241';
$ASE_plugin_raw = <<<'NOWDOC'
a:11:{s:2:"id";s:2:"19";s:4:"name";s:18:"Page TOC Generator";s:11:"description";s:0:"";s:11:"editor_type";s:1:"0";s:8:"category";s:1:"3";s:10:"cache_type";s:1:"0";s:10:"plugincode";s:11551:"/**********************************************************************************************************************
...
foreach($header_tags as $tags){
	...
	$display_content .=  "\n<li><a href=\"#".strip_special_chars(strip_tags($named_anchors[$i]))."_".$temp."\">". strip_tags($named_anchors[$i]) ."</a></li>";	
	$prev_tag = $tag;
